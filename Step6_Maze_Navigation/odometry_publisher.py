...
class print_transformed_odom(Node):
    def __init__(self):
        ...
        self.odom_pub = self.create_publisher(
            Pose2D,
            '/transferred_odom', #what should my topic name here. can i use whatever I want
            10
        )
    ...
    def update_Odometry(self,Odom):
        ...
        odom_msg.x = self.globalPos.x
        odom_msg.y = self.globalPos.y
        odom_msg.theta = self.globalAng
